...
const Move4 = () => {
  ...
  useEffect(() => {
    const loadImages = async () => {
      const [img1, img2, img3, img4] = await Promise.all([
        ...
        getBase64('/tv/pictures/tv1/move-4/regular/03.png'),
        getBase64('/tv/pictures/tv1/move-4/regular/04.png')
      ]);
  ...
  const handleImageClick = (imageId) => {
    ...
    setTimeout(() => {
      ...
      switch(imageId) {
        case 1:
          navigate('/tv/move_4/sections/InMove4_1');
          break;
        case 2:
          navigate('/tv/move_4/sections/InMove4_2');
          break;
        case 3:
          navigate('/tv/move_4/sections/InMove4_3');
          break;
        case 4:
          navigate('/tv/move_4/sections/InMove4_4');
          break;
        default:
          break;
      }
  ...
  return (
    <div className="w-full h-screen" style={{ backgroundColor: '#1D1C1A' }}>
      ...
      <button
        className="absolute top-6 right-6 transition-all duration-200 ease-in-out z-50 cursor-pointer border-0 outline-none focus:outline-none"
        style={{ 
          width: '29px', 
          height: '45px',
      ...
      <div style={{
        ...
        >
          ...
          >
            <img
              src={images.image1 || "/tv/pictures/tv1/move-4/regular/01.png"}
              alt="Scene 1"
        ...
        >
          ...
          >
            <img
              src={images.image2 || "/tv/pictures/tv1/move-4/regular/02.png"}
              alt="Scene 2"
              className="w-full h-full object-cover"
            />
          </div>
        ...
        >
          ...
          >
            <img
              src={images.image3 || "/tv/pictures/tv1/move-4/regular/03.png"}
              alt="Scene 3"
              className="w-full h-full object-cover"
            />
          </div>
        ...
        >
          ...
          >
            <img
              src={images.image4 || "/tv/pictures/tv1/move-4/regular/04.png"}
              alt="Scene 4"
              className="w-full h-full object-cover"
            />
          </div>
