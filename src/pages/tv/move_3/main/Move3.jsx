  ...
  useEffect(() => {
    const loadImages = async () => {
      const [img1, img2, img3, img4] = await Promise.all([
        ...
        getBase64('/tv/pictures/tv1/move-3/regular/02.png'),
        getBase64('/tv/pictures/tv1/move-3/regular/03.png'),
    ...
    <div className="w-full h-screen" style={{ backgroundColor: '#1D1C1A' }}>
      ...
      <div style={{
        ...
        >
          ...
          >
            <img
              src={images.image1 || "/tv/pictures/tv1/move-3/regular/01.png"}
              alt="Scene 1"
        ...
        >
          ...
          >
            <img
              src={images.image2 || "/tv/pictures/tv1/move-3/regular/02.png"}
              alt="Scene 2"
              className="w-full h-full object-cover"
            />
          </div>
        ...
        >
          ...
          >
            <img
              src={images.image3 || "/tv/pictures/tv1/move-3/regular/03.png"}
              alt="Scene 3"
              className="w-full h-full object-cover"
            />
          </div>
        ...
        >
          ...
          >
            <img
              src={images.image4 || "/tv/pictures/tv1/move-3/regular/04.png"}
              alt="Scene 4"
              className="w-full h-full object-cover"
            />
          </div>
